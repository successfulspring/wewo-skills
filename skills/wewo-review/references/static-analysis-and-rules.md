...
Independently inspect the Diff or scoped snapshot/comparison and affected code
for concrete correctness defects, repository-rule violations, invalid state assumptions, error/resource
...
Apply the same treatment to those explicitly included in a snapshot.
